...
pub fn run(name: &str, output: Option<&str>) -> Result<()> {
    ...
    match role {
        ...
        Role::Transform => {
            println!("  3. Replace the config validation stub in src/config.rs");
...
mod tests {
    ...
    fn scaffold_source_generates_explicit_unimplemented_stubs() {
        ...
        assert!(reader_rs.contains("NOT PRODUCTION-READY"));
        assert!(reader_rs.contains("PluginError::internal("));
        assert!(reader_rs.contains("\"UNIMPLEMENTED\""));
        assert!(schema_rs.contains("NOT PRODUCTION-READY"));
    ...
    fn scaffold_destination_generates_explicit_unimplemented_stubs() {
        ...
        assert!(client_rs.contains("PluginError::config("));
        assert!(client_rs.contains("\"UNIMPLEMENTED\""));
        assert!(writer_rs.contains("NOT PRODUCTION-READY"));
    ...
    fn scaffold_transform_generates_explicit_unimplemented_stubs() {
        ...
        assert!(main_rs.contains("ValidationStatus::Failed"));
        assert!(main_rs.contains("Replace the scaffold validation stub before shipping"));
