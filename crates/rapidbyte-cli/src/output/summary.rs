...
fn unique_stream_count(metrics: &[rapidbyte_engine::StreamShardMetric]) -> usize {
...
fn aggregate_streams(metrics: &[rapidbyte_engine::StreamShardMetric]) -> Vec<StreamAggregate> {
