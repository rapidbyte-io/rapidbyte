...
/// Set up an agent, submit a pipeline, and poll a task.
/// Returns `(task_id, run_id, lease_epoch)`.
///
/// # Panics
///
/// Panics if any repository operation fails (test-only helper).
pub async fn setup_running_task(tc: &TestContext) -> (String, String, u64) {
