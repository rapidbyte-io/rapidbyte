...
// ---------------------------------------------------------------------------
// Arrow column type helpers & COPY text formatting
// ---------------------------------------------------------------------------
...
fn format_copy_typed_value(buf: &mut Vec<u8>, col: &TypedCol<'_>, row_idx: usize) {
    match col {
        TypedCol::Null => {
...
// ---------------------------------------------------------------------------
// Batch write operations (INSERT, COPY, per-row fallback)
// ---------------------------------------------------------------------------
